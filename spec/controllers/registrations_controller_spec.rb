  ...
  describe "POST #create" do
    context "with valid parameters" do
      it "creates a new user" do
        user_params = { email: "test@example.com", password: "password", password_confirmation: "password", username: "testuser" }
        expect {
    ...
    context "with invalid parameters" do
      it "does not create a new user" do
        user_params = { email: "invalid_email", password: "password", password_confirmation: "password", username: "testuser" }
        expect {
          post :create, params: { user: user_params }
